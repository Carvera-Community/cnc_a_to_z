...
![](.gitbook/assets/shapeoko/toolpaths_base_design.png)
...
![](.gitbook/assets/shapeoko/toolpaths_pocket_single_pass.png)
...
![](.gitbook/assets/shapeoko/toolpaths_linear_ramping.png)

![](.gitbook/assets/shapeoko/toolpaths_helix_ramping.png)

Here's an alternate view of linear ramping into the material:

![](.gitbook/assets/shapeoko/page_134b_800.png)
...
![](.gitbook/assets/shapeoko/toolpaths_pocket_multi_pass.png)
...
![](.gitbook/assets/shapeoko/toolpaths_stepover_and_corners.png)

* the **stepover \(**a.k.a. ****width of cut, a.k.a. radial width of cut\) ****parameter of the toolpath controls how close to each other successive loops of the toolpaths are, in this case the stepover was chosen to be 50% of the endmill diameter for simplicity. Check out the [Feeds & speeds](shapeoko/feeds-and-speeds-basics.md) section for recommended stepover values, and how this affects chip thinning and ultimately the optimal feeds and speeds.
* in **corners** two things happen:
  * the cutter engagement temporarily increases \(see tool engagement in the [Feeds & speeds](shapeoko/feeds-and-speeds-basics.md#corners) section\). Nothing to be concerned about in many cases, but this limits the feeds and speeds to being more conservative than they could be. This is where advanced toolpaths help, _e.g._ adaptive clearing, more on this later.
...
![](.gitbook/assets/shapeoko/toolpaths_cc_fake_rest_machining.png)
...
![](.gitbook/assets/shapeoko/toolpaths_pocket_zigzag.png)

And then there is the matter of the DOC and WOC. As covered in the [Feeds & speeds](shapeoko/feeds-and-speeds-basics.md#choosing-doc-and-woc) section, you can either go for a low DOC and high WOC, or high DOC and low WOC. 
...
![](.gitbook/assets/shapeoko/toolpaths_pocketing_lowdoc.png)
...
![](.gitbook/assets/shapeoko/toolpaths_pocketing_highdoc_f360_helixentry%20%281%29.png)
...
![](.gitbook/assets/shapeoko/toolpaths_pocketing_highdoc_f360_lowwoc.png)
...
![](.gitbook/assets/shapeoko/toolpaths_pocketing_highdoc_cc_clearingentry.png)

* this would clear the way for a second toolpath doing a single pass at full depth, and 20% stepover:

![](.gitbook/assets/shapeoko/toolpaths_pocketing_highdoc_cc_lowwoc.png)
...
![](.gitbook/assets/shapeoko/toolpaths_contour_pocket_profile.png)
...
![](.gitbook/assets/shapeoko/toolpaths_nonadaptivepocketing.png)
...
![](.gitbook/assets/shapeoko/toolpaths_adaptivepocketing.png)
...
![](.gitbook/assets/shapeoko/toolpaths_contour_adaptive_profile.png)
...
![](.gitbook/assets/shapeoko/toolpaths_contour_adaptive_profile_preview.png)
...
{% hint style="info" %}
Since adaptive clearing is typically used with a small WOC \(much lower than 50% of the endmill diameter\), chip thinning must be taken into account in the feeds and speeds, as described in the [Feeds & speeds](shapeoko/feeds-and-speeds-basics.md#chip-thinning) section
{% endhint %}
...
![](.gitbook/assets/shapeoko/toolpaths_vcarve_chevron_design.png)
...
![](.gitbook/assets/shapeoko/toolpaths_vcarve_text_flatdepth.png)
...
![](.gitbook/assets/shapeoko/vbit_offset.png)
...
![](.gitbook/assets/shapeoko/toolpaths_roughing.png)
...
![](.gitbook/assets/shapeoko/toolpaths_finishing.png)
...
![](.gitbook/assets/shapeoko/page_133_800.png)
...
![](.gitbook/assets/shapeoko/page_134a_800.png)
...
![](.gitbook/assets/shapeoko/toolpaths_3d_example.png)
...
![](.gitbook/assets/shapeoko/ccpro_3droughing.PNG)

And then adding 3D finishing passes:

![](.gitbook/assets/shapeoko/ccpro_3dfinishing.PNG)
...
![](.gitbook/assets/shapeoko/toolpaths_camotics_screenshot.png)
